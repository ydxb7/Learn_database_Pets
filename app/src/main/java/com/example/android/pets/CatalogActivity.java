...
public class CatalogActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDbHelper = new PetDbHelper(this); // 不会创建database
        ...
        // setup item k listener
        petListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long id) {
                Intent intent = new Intent(CatalogActivity.this, EditorActivity.class);

                // 生成URI。Form the content URI that represents the specific pet that was clicked on,
...
//        mCursorAdapter.changeCursor(data);
    ...
    private void deleteAllPets() {
        ...
        if (rowsDeleted == 0) {
            ...
            Toast.makeText(this, getString(R.string.catalog_delete_all_pet_failed),
